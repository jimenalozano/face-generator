...
def encode_images(src_dir, generated_images_dir, dlatent_dir, network_pkl='gdrive:networks/stylegan2-ffhq-config-f.pkl',
...
if __name__ == "__main__":
    ...
    parser.add_argument('--network_pkl', default='gdrive:networks/stylegan2-ffhq-config-f.pkl', help='Path to local '
                                                                                                     'copy of '
                                                                                                     'stylegan2-ffhq'
                                                                                                     '-config-f.pkl')
    ...
    encode_images(args.src_dir, args.generated_images_dir, args.dlatent_dir, args.network_pkl, args.batch_size, args.image_size,
                  args.lr, args.iterations, args.randomize_noise)
